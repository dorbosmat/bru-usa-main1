...
export const translations: Record<Language, TranslationKeys> = {
  en: {
    ...
    formCallbackConfirm: "A contractor may call you within the next few minutes.",
  ...
  es: {
    ...
    formCallbackConfirm: "Un contratista puede llamarte en los próximos minutos.",
  ...
  ar: {
    ...
    formCallbackConfirm: "قد يتصل بك مقاول خلال الدقائق القادمة.",
  ...
  ru: {
    ...
    formCallbackConfirm: "Подрядчик может позвонить вам в ближайшие минуты.",
  ...
  pt: {
    ...
    formCallbackConfirm: "Um empreiteiro pode ligar nos próximos minutos.",
  ...
  he: {
    ...
    formCallbackConfirm: "קבלן עשוי להתקשר אליך בדקות הקרובות.",
  ...
  hi: {
    ...
    formCallbackConfirm: "एक ठेकेदार कुछ मिनटों में कॉल कर सकता है।",
  ...
  zh: {
    ...
    formCallbackConfirm: "承包商可能在几分钟内给您回电。",
    formNeedHelp: "现在需要帮助？",
