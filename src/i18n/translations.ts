...
export const translations: Record<Language, TranslationKeys> = {
  en: {
    ...
    contactGetInTouchDesc: "Have a question or ready for your free estimate? Fill out the form and our team will get back to you as soon as we can.",
    contactPhone: "Phone",
    contactEmail: "Email",
    ...
    getQuoteSubtitle: "Fill out the form below. We'll review your request and refer you to an independent licensed contractor for a free, no-obligation estimate.",
